...
public class LoginDao {
	...
	public User getPasswordByUsername(String username) {
		try (Connection conn = ConnectionUtil.getConnection()) {
			String sql = "SELECT ers_user_id, ers_password FROM ers_users WHERE ers_username = ?";
			...
			if (rs.next()) {
				...
				return new User(id, username, password, new ArrayList<Reimbursement>());
			} else {
	...
	public List<Reimbursement> getReimbursements(int id) {
		...
		try (Connection conn = ConnectionUtil.getConnection()) {
			...
			while (rs.next()) {
				...
				reimbursement.setResolve_time(reimbursement.getReimb_resolved() != null ? reimbursement.getReimb_resolved().toString() : null);
				...
				reimbursement.setSubmit_time(reimbursement.getReimb_submitted().toString());
