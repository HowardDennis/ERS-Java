...
public class Reimbursement {
	...
	public Reimbursement(int reimb_id, BigDecimal reimb_amount, Timestamp reimb_submitted, String submit_time,
			String resolve_time, Timestamp reimb_resolved, String reimb_description, byte[] reimb_receipt,
			String reimb_author, String reimb_resolver, String reimb_status, String reimb_type) {
		super();
		this.reimb_id = reimb_id;
		this.reimb_amount = reimb_amount;
		this.reimb_submitted = reimb_submitted;
